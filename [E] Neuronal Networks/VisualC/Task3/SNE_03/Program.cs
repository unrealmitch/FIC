...
namespace SNE_03
{
    class Program
    {
        static void Intro()
        {
            Console.WriteLine("### Model association ###");
        ...
        static void Main(string[] args)
        {
            ...
            // Z0 - disturbed
            Console.WriteLine("z0 - interrumpido");
            Console.WriteLine("------------------------");
            displayResults(z0_);
            Console.WriteLine();

            // Z0 - disturbed result
            Console.WriteLine("R: z0 - interrumpido\tF(z0')");
            Console.WriteLine("--------------------------------------");
            y = calculateF(W, z0_);
            displayResults(y);
            Console.WriteLine();
            ...
            // Z1 - disturbed
            Console.WriteLine("z1 - interrumpido");
            Console.WriteLine("------------------------");
            displayResults(z1_);
            Console.WriteLine();

            // Z1 - disturbed result
            Console.WriteLine("R:z1 - interrumpido\tF(z1')");
            Console.WriteLine("--------------------------------------");
            y = calculateF(W, z1_);
            displayResults(y);
            Console.WriteLine();
